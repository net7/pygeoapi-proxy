...
test('admin tables use tanstack filtering and expected labels', function () {
    ...
    expect($users)->toContain("from '@tanstack/react-table'")
        ...
        ->and($users)->toContain('border-success/25 bg-success/10 text-success-emphasis uppercase')
...
test('admin edit user modal explains email reconciliation and requires confirmation', function () {
    ...
    expect($source)
        ...
        ->toContain('InfoIcon className="mt-0.5 size-5 text-success"')
        ->toContain('border-success/25 bg-success/10 text-success-emphasis [&>svg]:size-5')
...
test('admin user status modal uses contextual confirmation panels', function () {
    ...
    expect($source)
        ...
        ->toContain('border-success/25 bg-success/10 text-success-emphasis')
        ->toContain('border-destructive-emphasis/25 bg-destructive-emphasis/10 text-destructive-emphasis')
