...
return [
    ...
    'attributes' => [
        ...
        'ids' => 'elementi selezionati',
        'ids.*' => 'elemento selezionato',
        'inputFiles' => 'file di input',
        'inputFiles.*' => 'file di input',
        'inputFiles.*.path' => 'percorso del file',
        'inputFiles.*.path.*' => 'componente del percorso',
        'inputFiles.*.name' => 'nome del file',
        'inputFiles.*.content' => 'contenuto del file',
        'inputFiles.*.encoding' => 'codifica del file',
        'inputs' => 'dati di input',
        'name' => 'nome',
        'note' => 'nota',
        'note.type' => 'tipo della nota',
        'note.content' => 'contenuto della nota',
        'outputs' => 'output',
        'outputs.*' => 'output',
        'outputs.*.format' => 'formato di output',
        'outputs.*.format.mediaType' => 'tipo di contenuto dell’output',
        'outputs.*.format.encoding' => 'codifica dell’output',
        'outputs.*.format.schema' => 'schema dell’output',
        'password' => 'password',
